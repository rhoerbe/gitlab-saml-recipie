...
gitlab_rails['omniauth_providers'] = [
  { "name" => 'shibboleth',
    "args" => {
      ...
      "uid_field" => 'HTTP_X_PVP_USERID',
      "name_field" => 'HTTP_X-PVP_GIVENNAME' + ' ' + 'HTTP_X_PVP_PRINCIPALNAME',
      "info_fields" => {
        "first_name" => 'HTTP_X_PVP_GIVENNAME',
        "last_name" => 'HTTP_X_PVP_PRINCIPALNAME',
        "email" => 'HTTP_X_PVP_MAIL'
      },
      "debug" => false
    }
  }
...
## Prevent Postgres from trying to allocate 25% of total memory in the test environment
